    ...
    <div class="admin-content">
        ...
        <div class="am-g">
            <div class="am-u-sm-12">
                <form action="admin/save_blog" method="post" class="am-form" enctype="multipart/form-data">
                    ...
                    <div class="am-g am-margin-top-am">
                        ...
                        <div class="am-u-sm-12 am-u-md-10">
                            <textarea rows="10" placehoder="请使用富文本编辑插件" name="content"></textarea>
                        </div>
                    </div>
                    <div class="am-margin">
                        <input type="submit" class="am-btn am-btn-primary am-btn-xs" value="提交保存">
                        <input type="submit" class="am-btn am-btn-primary am-btn-xs" value="放弃保存">
